...
function updateLoadingState() {
    // این تابع می‌تونه خالی باشه یا برای نمایش لودینگ استفاده بشه
...
function changePage(pageName) {
    ...
    switch(pageName) {
        ...
        case 'profile':
            ...
            break;
        case 'game':
            // اگه gameId وجود داشت، صفحه بازی رو رندر کن
            ...
            gamesHTML += `
                <div class="game-card" onclick="joinGame(${game.id})">
                    <div class="game-header">
                        ...
                        <span class="game-status">${game.status || 'در انتظار'}</span>
                    </div>
                    <div class="game-info">
...
function createGame() {
    ...
    const success = sendToBot('create', {
...
function joinGame(gameId) {
    ...
    const success = sendToBot('join', { gameId: gameId });
...
function confirmPurchase() {
    ...
    const success = sendToBot('buy', { coins: App.selectedCoins });
